...
(function() {
  ...
  function updateCategoryCounts() {
    const counts = {
      kitengela: 0, syokimau: 0, mlolongo: 0, 'imara daima': 0, 'athi river': 0
    };
    ...
    document.getElementById('athiRiverCount') && (document.getElementById('athiRiverCount').textContent = counts['athi river']);
  }
