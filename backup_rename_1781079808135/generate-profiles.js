...
const cityLandmarksList = {
  ...
  "Athi River": [
    "along Mombasa Road, near Athi River town and the Industrial Area",
    "close to the Athi River township",
...
const faqPools = [
  [ // Pool 0: standard
    ...
    { q: "How does the verification and payment work?", a: "You pay a small verification fee of 100 KES via M-Pesa. Once confirmed, you instantly receive {{name}}'s full phone number." }
  ],
  [ // Pool 1: privacy & discretion
    ...
    { q: "Do I need to pay a deposit?", a: "No, only the one‑time 100 KES verification fee via M-Pesa is required to unlock the number." }
  ],
  ...
  [ // Pool 4: first‑time client
    ...
    { q: "What forms of payment are accepted?", a: "Only M-Pesa for the 100 KES verification fee. No other payments are required on this site." }
  ],
  ...
  const faqPage = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": { "@type": "Answer", "text": "You pay a small verification fee of 100 KES via M-Pesa. Once confirmed, you instantly receive the escort's full phone number." }
      }
    ]
  };
...
for (const profile of profiles) {
  ...
  if (localTipChance) {
    ...
    const tipPool = [
      ...
      `Many clients prefer the convenience of the ${profile.city} Expressway – easy access from Nairobi and Athi River.`,
