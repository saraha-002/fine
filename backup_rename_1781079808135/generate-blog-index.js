...
function getCity(html, filename) {
  ...
  const cities = ['kitengela', 'syokimau', 'mlolongo', 'imara daima', 'athi river'];
...
<head>
  ...
  <meta name="description" content="Local nightlife guides, escort tips, and city insights for Kitengela, Syokimau, Mlolongo, Imara Daima & Athi River.">
...
<body>
  ...
  <div class="category-filters" id="categoryFilters">
    ...
    <button class="category-btn" data-category="athi river">Athi River</button>
  </div>
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-widget">
        ...
        <ul class="category-list" id="categoryList">
          ...
          <li><a href="#" data-category="athi river">Athi River <span id="athiRiverCount">0</span></a></li>
        </ul>
      </div>
    </aside>
  </div>
